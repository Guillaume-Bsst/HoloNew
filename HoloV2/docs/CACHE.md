...
| **Ground (plat)** | — (analytique `z`, pas de SDF — défaut) | — | — | **non caché** |
...
PAS une vérité constante : plat par défaut (analytique, sans SDF, non caché), mais il **reflète
l'environnement** (escalier/pente/climbing) via une **SDF de terrain** — alors cachée comme un
